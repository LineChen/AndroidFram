...
import com.beiing.androidfram.test_recyclerview.adapter.SimpleRecyclerviewAdapter;
...
//        recyclerView.setLayoutManager(new GridLayoutManager(this, 1));
        ...
        adapter.setOnItemClickListener(new OnItemClickListener<Content>() {
            ...
            public void onItemClick(ViewGroup parent, View view, Content content, int position) {
                Toast.makeText(SimpleRecyclerViewActivity.this, position + content.getTitle(), Toast.LENGTH_SHORT).show();
            }
